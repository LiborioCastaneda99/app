              ...
              <div class="cell-sm-8 cell-md-6 cell-lg-4">
                ...
                <form class="rd-mailform text-left" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-gray" id="login" type="text" name="login" data-constraints="@Required">
                  </div>
                  <div class="form-group">
                  ...
                  <button class="btn btn-info btn-block btn-sm offset-top-22" type="submit">sign in</button>
                </form>
              </div>
            </div>
          </div>
            ...
            <div class="cell-sm-6 cell-lg-3">
              ...
              <div class="offset-top-30 p">
                ...
                <div class="unit unit-horizontal unit-spacing-15 offset-top-10 text-left">
                  ...
                  <div class="unit-body"><a class="text-gray" href="mailto:#">info@demolink.org</a></div>
                </div>
