...
<html lang="es">
  <head>
    <!-- Site Title-->
    <title>GESTIONAR USUARIOs | Logistic & Solution KLM</title>
                  ...
                  <div class="rd-navbar-inner">
                    ...
                    <div class="rd-navbar-nav-wrap">
                      ...
                      <ul class="rd-navbar-nav">
                        ...
                        <li class="active"><a href="gestionar_usuario.php">GESTIONAR USUARIO</a></li>
                        <?php if($user[7] == 1):?>
          ...
          <section style="background: no-repeat url('https://www.ealde.es/wp-content/uploads/2019/05/gestion-de-personas-recursos-humanos.jpg') center; background-size: cover;">
            <div class="breadcrumb-wrapper">
              <div class="shell context-dark section-30 section-md-top-280">
                <h1 class="offset-top-20 text-ubold">GESTIONAR USUARIOs</h1>
                <ol class="breadcrumb">
                </ol>
              </div>
            </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        var idEm = '<?php echo $idEmpresa_; ?>';        
		$('#tablaDatatable').load('tabla_gestionar_empleados.php'+idEm);
	});
  ...
  $('#btnActualizar').click(function(){
      ...
      if ((nombresU == "")|| (correoU == "")|| (apellidosU == "")|| (telefonoU == "")|| (cedulaU == "")
