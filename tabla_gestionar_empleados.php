		...
		<table class="table table-striped small" id="cargarListadoCursos">
			<thead class="text-center">
				<tr>
					...
					<th class="success" width="16%">Acciones</th>
					...
					?>
						<tr class="text-center">
							...
							<td style="text-align: center;" >
								<button class="btn btn-primary btn-icon btn-icon-center btn-sm datos" data-text="<?php echo 'http://accountstoretv.000webhostapp.com/qr/generate.php?text=' ?>" data-descr="<?php echo htmlentities($mostrar[1]); ?>" data-toggle="modal" data-target="#staticBackdrop">
