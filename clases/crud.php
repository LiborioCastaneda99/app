<?php 
	...
	class crud{
		public function agregar($datos){
			...
			$sql="INSERT INTO empleados ( nombre, apellidos, cedula, tel, empresa, arl, img_usu, ips, tipo_seguro, email, cargo, ciudad, direccion) 
		...
		public function obtenDatos($id){
			...
			$conexion = $obj->conexion();
			$tildes = $conexion->query("SET NAMES 'utf8'");
			$sql = "SELECT id, nombre, apellidos, cedula, tel, empresa, arl, ips, tipo_seguro, email, cargo, ciudad, direccion FROM empleados WHERE id = '$id' and activo = 1";
